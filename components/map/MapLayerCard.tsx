        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-pantaneiro-lime rounded-lg flex items-center justify-center">
              <Layers className="w-4 h-4 text-pantaneiro-green" />
            </div>
            <div>
              <CardTitle className="text-lg font-semibold text-white flex items-center gap-2">
                {title}
                <Leaf className="w-4 h-4 text-pantaneiro-lime" />
              </CardTitle>
              <p className="text-xs text-white/80">
                {activeLayersCount} de {totalLayersCount} camadas ativas
              </p>
            </div>
          </div>
          <Button
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center space-x-3 flex-1">
                        ...
                        >
                          <div
                            className="w-3 h-3 mr-3 rounded-sm border border-pantaneiro-lime/30 shadow-sm"
